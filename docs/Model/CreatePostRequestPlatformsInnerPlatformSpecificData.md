...
------------ | ------------- | ------------- | -------------
**thread_items** | [**\Late\Model\TwitterPlatformDataThreadItemsInner[]**](TwitterPlatformDataThreadItemsInner.md) | Sequence of posts in a Threads thread (root then replies in order). | [optional]

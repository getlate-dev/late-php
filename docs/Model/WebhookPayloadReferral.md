...
**event** | **string** |  |
**referral** | [**\Zernio\Model\WebhookPayloadReferralReferral**](WebhookPayloadReferralReferral.md) |  |
**sender** | [**\Zernio\Model\WebhookPayloadReferralSender**](WebhookPayloadReferralSender.md) |  |

...
**serves_num_people** | **int** | Number of people the item serves | [optional]
**preparation_methods** | **string[]** | Preparation methods (e.g. GRILLED, FRIED) | [optional]
**media_keys** | **string[]** | Media references for item photos | [optional]

...
**platform_specific_data** | [**\Zernio\Model\LinkedInAdsPlatformData**](LinkedInAdsPlatformData.md) |  | [optional]
...
**special_ad_category_country** | **string[]** | Meta (metaads) only. 2-letter ISO country codes the special ad category applies to. Requires specialAdCategories to be set (400 otherwise). | [optional]

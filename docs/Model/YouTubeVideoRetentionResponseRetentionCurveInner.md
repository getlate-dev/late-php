...
**started_watching** | **int** | Viewers who started watching in this segment. 0 when YouTube has no segment-level data for the video. | [optional]
**stopped_watching** | **int** | Viewers who stopped watching in this segment. 0 when YouTube has no segment-level data for the video. | [optional]

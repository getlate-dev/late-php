...
------------ | ------------- | ------------- | -------------
**questions** | [**\Zernio\Model\LinkedInLeadFormPlatformDataQuestionsInner[]**](LinkedInLeadFormPlatformDataQuestionsInner.md) |  |
**privacy_policy_link_text** | **string** |  | [optional]
**follow_up_action_url** | **string** |  | [optional]
**locale** | [**\Zernio\Model\LinkedInLeadFormPlatformDataLocale**](LinkedInLeadFormPlatformDataLocale.md) |  | [optional]
...
**consents** | [**\Zernio\Model\LinkedInLeadFormPlatformDataConsentsInner[]**](LinkedInLeadFormPlatformDataConsentsInner.md) |  | [optional]

...
class GMBReviewsApi
{
    ...
    /**
     * Operation deleteGoogleBusinessReviewReply
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteGoogleBusinessReviewReply'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->deleteGoogleBusinessReviewReplyWithHttpInfo($account_id, $review_id, $contentType);
        return $response;
    }

    /**
     * Operation deleteGoogleBusinessReviewReplyWithHttpInfo
     *
     * Delete a review reply
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
    ...
    {
        $request = $this->deleteGoogleBusinessReviewReplyRequest($account_id, $review_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\DeleteGoogleBusinessReviewReply200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation deleteGoogleBusinessReviewReplyAsync
     *
     * Delete a review reply
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteGoogleBusinessReviewReplyAsync($account_id, $review_id, string $contentType = self::contentTypes['deleteGoogleBusinessReviewReply'][0])
    {
        return $this->deleteGoogleBusinessReviewReplyAsyncWithHttpInfo($account_id, $review_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteGoogleBusinessReviewReplyAsyncWithHttpInfo
     *
     * Delete a review reply
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteGoogleBusinessReviewReplyAsyncWithHttpInfo($account_id, $review_id, string $contentType = self::contentTypes['deleteGoogleBusinessReviewReply'][0])
    {
        $returnType = '\Zernio\Model\DeleteGoogleBusinessReviewReply200Response';
        $request = $this->deleteGoogleBusinessReviewReplyRequest($account_id, $review_id, $contentType);
    ...
    /**
     * Create request for operation 'deleteGoogleBusinessReviewReply'
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
     * @param  string $review_id The review ID portion (e.g. \&quot;AIe9_BGx1234567890\&quot;), not the full resource name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteGoogleBusinessReviewReply'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteGoogleBusinessReviewReplyRequest($account_id, $review_id, string $contentType = self::contentTypes['deleteGoogleBusinessReviewReply'][0])
    {

        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling deleteGoogleBusinessReviewReply'
            );
        }
        ...
        if ($review_id === null || (is_array($review_id) && count($review_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $review_id when calling deleteGoogleBusinessReviewReply'
            );
        }


        $resourcePath = '/v1/accounts/{accountId}/gmb-reviews/{reviewId}/reply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation replyToGoogleBusinessReview
     *
     * Reply to a review
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
     * @param  string $review_id The review ID portion (e.g. \&quot;AIe9_BGx1234567890\&quot;), not the full resource name (required)
     * @param  \Zernio\Model\ReplyToGoogleBusinessReviewRequest $reply_to_google_business_review_request reply_to_google_business_review_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['replyToGoogleBusinessReview'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->replyToGoogleBusinessReviewWithHttpInfo($account_id, $review_id, $reply_to_google_business_review_request, $contentType);
        return $response;
    }

    /**
     * Operation replyToGoogleBusinessReviewWithHttpInfo
     *
     * Reply to a review
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
     * @param  string $review_id The review ID portion (e.g. \&quot;AIe9_BGx1234567890\&quot;), not the full resource name (required)
     * @param  \Zernio\Model\ReplyToGoogleBusinessReviewRequest $reply_to_google_business_review_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['replyToGoogleBusinessReview'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        $request = $this->replyToGoogleBusinessReviewRequest($account_id, $review_id, $reply_to_google_business_review_request, $contentType);
    ...
    /**
     * Operation replyToGoogleBusinessReviewAsync
     *
     * Reply to a review
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replyToGoogleBusinessReviewAsync($account_id, $review_id, $reply_to_google_business_review_request, string $contentType = self::contentTypes['replyToGoogleBusinessReview'][0])
    {
        return $this->replyToGoogleBusinessReviewAsyncWithHttpInfo($account_id, $review_id, $reply_to_google_business_review_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation replyToGoogleBusinessReviewAsyncWithHttpInfo
     *
     * Reply to a review
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replyToGoogleBusinessReviewAsyncWithHttpInfo($account_id, $review_id, $reply_to_google_business_review_request, string $contentType = self::contentTypes['replyToGoogleBusinessReview'][0])
    {
        $returnType = '\Zernio\Model\ReplyToGoogleBusinessReview200Response';
        $request = $this->replyToGoogleBusinessReviewRequest($account_id, $review_id, $reply_to_google_business_review_request, $contentType);
    ...
    /**
     * Create request for operation 'replyToGoogleBusinessReview'
     *
     * @param  string $account_id The Zernio account ID (from /v1/accounts) (required)
     * @param  string $review_id The review ID portion (e.g. \&quot;AIe9_BGx1234567890\&quot;), not the full resource name (required)
     * @param  \Zernio\Model\ReplyToGoogleBusinessReviewRequest $reply_to_google_business_review_request (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function replyToGoogleBusinessReviewRequest($account_id, $review_id, $reply_to_google_business_review_request, string $contentType = self::contentTypes['replyToGoogleBusinessReview'][0])
    {

        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling replyToGoogleBusinessReview'
            );
        }
        ...
        if ($review_id === null || (is_array($review_id) && count($review_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $review_id when calling replyToGoogleBusinessReview'
            );
        }

        // verify the required parameter 'reply_to_google_business_review_request' is set
        if ($reply_to_google_business_review_request === null || (is_array($reply_to_google_business_review_request) && count($reply_to_google_business_review_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reply_to_google_business_review_request when calling replyToGoogleBusinessReview'
            );
        }
        ...
        // for model (json/xml)
        if (isset($reply_to_google_business_review_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($reply_to_google_business_review_request));
            } else {
                $httpBody = $reply_to_google_business_review_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

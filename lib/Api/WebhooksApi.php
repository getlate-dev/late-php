...
class WebhooksApi
{
     ...
     * @param  string|null $event Filter by event type (optional)
     * @param  string|null $webhook_id Filter by webhook ID (optional)
    ...
    {
        list($response) = $this->getWebhookLogsWithHttpInfo($limit, $status, $event, $webhook_id, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getWebhookLogsRequest($limit, $status, $event, $webhook_id, $contentType);
    ...
    {
        return $this->getWebhookLogsAsyncWithHttpInfo($limit, $status, $event, $webhook_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $returnType = '\Late\Model\GetWebhookLogs200Response';
        $request = $this->getWebhookLogsRequest($limit, $status, $event, $webhook_id, $contentType);

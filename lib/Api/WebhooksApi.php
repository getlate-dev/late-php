...
class WebhooksApi
{
    ...
    /**
     * Operation redeliverWebhookEvent
     *
     * Redeliver a webhook event
     *
     * @param  \Zernio\Model\RedeliverWebhookEventRequest $redeliver_webhook_event_request redeliver_webhook_event_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['redeliverWebhookEvent'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->redeliverWebhookEventWithHttpInfo($redeliver_webhook_event_request, $contentType);
        return $response;
    }

    /**
     * Operation redeliverWebhookEventWithHttpInfo
     *
     * Redeliver a webhook event
     *
     * @param  \Zernio\Model\RedeliverWebhookEventRequest $redeliver_webhook_event_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['redeliverWebhookEvent'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        $request = $this->redeliverWebhookEventRequest($redeliver_webhook_event_request, $contentType);
    ...
    /**
     * Operation redeliverWebhookEventAsync
     *
     * Redeliver a webhook event
     *
     * @param  \Zernio\Model\RedeliverWebhookEventRequest $redeliver_webhook_event_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redeliverWebhookEventAsync($redeliver_webhook_event_request, string $contentType = self::contentTypes['redeliverWebhookEvent'][0])
    {
        return $this->redeliverWebhookEventAsyncWithHttpInfo($redeliver_webhook_event_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation redeliverWebhookEventAsyncWithHttpInfo
     *
     * Redeliver a webhook event
     *
     * @param  \Zernio\Model\RedeliverWebhookEventRequest $redeliver_webhook_event_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redeliverWebhookEventAsyncWithHttpInfo($redeliver_webhook_event_request, string $contentType = self::contentTypes['redeliverWebhookEvent'][0])
    {
    ...
    /**
     * Create request for operation 'redeliverWebhookEvent'
     *
     * @param  \Zernio\Model\RedeliverWebhookEventRequest $redeliver_webhook_event_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['redeliverWebhookEvent'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function redeliverWebhookEventRequest($redeliver_webhook_event_request, string $contentType = self::contentTypes['redeliverWebhookEvent'][0])
    {

        // verify the required parameter 'redeliver_webhook_event_request' is set
        if ($redeliver_webhook_event_request === null || (is_array($redeliver_webhook_event_request) && count($redeliver_webhook_event_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $redeliver_webhook_event_request when calling redeliverWebhookEvent'
            );
        }


        $resourcePath = '/v1/webhooks/logs/redeliver';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($redeliver_webhook_event_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($redeliver_webhook_event_request));
            } else {
                $httpBody = $redeliver_webhook_event_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

...
class GMBFoodMenusApi
{
    ...
    public function getGoogleBusinessFoodMenusRequest($account_id, string $contentType = self::contentTypes['getGoogleBusinessFoodMenus'][0])
    {
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling getGoogleBusinessFoodMenus'
            );
        }
    ...
    public function updateGoogleBusinessFoodMenusRequest($account_id, $update_google_business_food_menus_request, string $contentType = self::contentTypes['updateGoogleBusinessFoodMenus'][0])
    {
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling updateGoogleBusinessFoodMenus'
            );
        }

        // verify the required parameter 'update_google_business_food_menus_request' is set
        if ($update_google_business_food_menus_request === null || (is_array($update_google_business_food_menus_request) && count($update_google_business_food_menus_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_google_business_food_menus_request when calling updateGoogleBusinessFoodMenus'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_google_business_food_menus_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_google_business_food_menus_request));
            } else {
                $httpBody = $update_google_business_food_menus_request;
            }

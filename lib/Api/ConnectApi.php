...
class ConnectApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['completeWhatsAppPhoneSelection'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\CompleteWhatsAppPhoneSelection200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject|\Zernio\Model\ErrorResponse|\Zernio\Model\ErrorResponse
     */
    public function completeWhatsAppPhoneSelection($complete_whats_app_phone_selection_request, $x_connect_token = null, string $contentType = self::contentTypes['completeWhatsAppPhoneSelection'][0])
    {
        list($response) = $this->completeWhatsAppPhoneSelectionWithHttpInfo($complete_whats_app_phone_selection_request, $x_connect_token, $contentType);
        return $response;
    }
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\CompleteWhatsAppPhoneSelection200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject|\Zernio\Model\ErrorResponse|\Zernio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function completeWhatsAppPhoneSelectionWithHttpInfo($complete_whats_app_phone_selection_request, $x_connect_token = null, string $contentType = self::contentTypes['completeWhatsAppPhoneSelection'][0])
    {
        $request = $this->completeWhatsAppPhoneSelectionRequest($complete_whats_app_phone_selection_request, $x_connect_token, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\CompleteWhatsAppPhoneSelection200Response',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function completeWhatsAppPhoneSelectionAsync($complete_whats_app_phone_selection_request, $x_connect_token = null, string $contentType = self::contentTypes['completeWhatsAppPhoneSelection'][0])
    {
        return $this->completeWhatsAppPhoneSelectionAsyncWithHttpInfo($complete_whats_app_phone_selection_request, $x_connect_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function completeWhatsAppPhoneSelectionAsyncWithHttpInfo($complete_whats_app_phone_selection_request, $x_connect_token = null, string $contentType = self::contentTypes['completeWhatsAppPhoneSelection'][0])
    {
        $returnType = '\Zernio\Model\CompleteWhatsAppPhoneSelection200Response';
        $request = $this->completeWhatsAppPhoneSelectionRequest($complete_whats_app_phone_selection_request, $x_connect_token, $contentType);
    ...
    /**
     * Create request for operation 'completeWhatsAppPhoneSelection'
     *
     * @param  \Zernio\Model\CompleteWhatsAppPhoneSelectionRequest $complete_whats_app_phone_selection_request (required)
     * @param  string|null $x_connect_token Alternative auth for API users&#39; end customers (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['completeWhatsAppPhoneSelection'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function completeWhatsAppPhoneSelectionRequest($complete_whats_app_phone_selection_request, $x_connect_token = null, string $contentType = self::contentTypes['completeWhatsAppPhoneSelection'][0])
    {

        // verify the required parameter 'complete_whats_app_phone_selection_request' is set
        if ($complete_whats_app_phone_selection_request === null || (is_array($complete_whats_app_phone_selection_request) && count($complete_whats_app_phone_selection_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $complete_whats_app_phone_selection_request when calling completeWhatsAppPhoneSelection'
            );
        }



        $resourcePath = '/v1/connect/whatsapp/select-phone-number';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($complete_whats_app_phone_selection_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($complete_whats_app_phone_selection_request));
            } else {
                $httpBody = $complete_whats_app_phone_selection_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \Zernio\Model\ConnectOpenAIAdsCredentialsRequest $connect_open_ai_ads_credentials_request connect_open_ai_ads_credentials_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectOpenAIAdsCredentials'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->connectOpenAIAdsCredentialsWithHttpInfo($connect_open_ai_ads_credentials_request, $contentType);
        return $response;
    }

    /**
     * Operation connectOpenAIAdsCredentialsWithHttpInfo
     *
     * Connect an OpenAI Ads account
     *
     * @param  \Zernio\Model\ConnectOpenAIAdsCredentialsRequest $connect_open_ai_ads_credentials_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectOpenAIAdsCredentials'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        $request = $this->connectOpenAIAdsCredentialsRequest($connect_open_ai_ads_credentials_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\ConnectOpenAIAdsCredentials200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation connectOpenAIAdsCredentialsAsync
     *
     * Connect an OpenAI Ads account
     *
     * @param  \Zernio\Model\ConnectOpenAIAdsCredentialsRequest $connect_open_ai_ads_credentials_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function connectOpenAIAdsCredentialsAsync($connect_open_ai_ads_credentials_request, string $contentType = self::contentTypes['connectOpenAIAdsCredentials'][0])
    {
        return $this->connectOpenAIAdsCredentialsAsyncWithHttpInfo($connect_open_ai_ads_credentials_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation connectOpenAIAdsCredentialsAsyncWithHttpInfo
     *
     * Connect an OpenAI Ads account
     *
     * @param  \Zernio\Model\ConnectOpenAIAdsCredentialsRequest $connect_open_ai_ads_credentials_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function connectOpenAIAdsCredentialsAsyncWithHttpInfo($connect_open_ai_ads_credentials_request, string $contentType = self::contentTypes['connectOpenAIAdsCredentials'][0])
    {
        $returnType = '\Zernio\Model\ConnectOpenAIAdsCredentials200Response';
        $request = $this->connectOpenAIAdsCredentialsRequest($connect_open_ai_ads_credentials_request, $contentType);
    ...
    /**
     * Create request for operation 'connectOpenAIAdsCredentials'
     *
     * @param  \Zernio\Model\ConnectOpenAIAdsCredentialsRequest $connect_open_ai_ads_credentials_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectOpenAIAdsCredentials'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function connectOpenAIAdsCredentialsRequest($connect_open_ai_ads_credentials_request, string $contentType = self::contentTypes['connectOpenAIAdsCredentials'][0])
    {

        // verify the required parameter 'connect_open_ai_ads_credentials_request' is set
        if ($connect_open_ai_ads_credentials_request === null || (is_array($connect_open_ai_ads_credentials_request) && count($connect_open_ai_ads_credentials_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $connect_open_ai_ads_credentials_request when calling connectOpenAIAdsCredentials'
            );
        }


        $resourcePath = '/v1/connect/openai-ads/credentials';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($connect_open_ai_ads_credentials_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($connect_open_ai_ads_credentials_request));
            } else {
                $httpBody = $connect_open_ai_ads_credentials_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation connectShopifyWithToken
     *
     * Connect a Shopify store with a custom-app Admin token
     *
     * @param  \Zernio\Model\ConnectShopifyWithTokenRequest $connect_shopify_with_token_request connect_shopify_with_token_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectShopifyWithToken'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\ConnectShopifyWithToken200Response|\Zernio\Model\InlineObject|\Zernio\Model\InlineObject3
     */
    public function connectShopifyWithToken($connect_shopify_with_token_request, string $contentType = self::contentTypes['connectShopifyWithToken'][0])
    {
        list($response) = $this->connectShopifyWithTokenWithHttpInfo($connect_shopify_with_token_request, $contentType);
        return $response;
    }

    /**
     * Operation connectShopifyWithTokenWithHttpInfo
     *
     * Connect a Shopify store with a custom-app Admin token
     *
     * @param  \Zernio\Model\ConnectShopifyWithTokenRequest $connect_shopify_with_token_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectShopifyWithToken'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\ConnectShopifyWithToken200Response|\Zernio\Model\InlineObject|\Zernio\Model\InlineObject3, HTTP status code, HTTP response headers (array of strings)
     */
    public function connectShopifyWithTokenWithHttpInfo($connect_shopify_with_token_request, string $contentType = self::contentTypes['connectShopifyWithToken'][0])
    {
        $request = $this->connectShopifyWithTokenRequest($connect_shopify_with_token_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\ConnectShopifyWithToken200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation connectShopifyWithTokenAsync
     *
     * Connect a Shopify store with a custom-app Admin token
     *
     * @param  \Zernio\Model\ConnectShopifyWithTokenRequest $connect_shopify_with_token_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function connectShopifyWithTokenAsync($connect_shopify_with_token_request, string $contentType = self::contentTypes['connectShopifyWithToken'][0])
    {
        return $this->connectShopifyWithTokenAsyncWithHttpInfo($connect_shopify_with_token_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation connectShopifyWithTokenAsyncWithHttpInfo
     *
     * Connect a Shopify store with a custom-app Admin token
     *
     * @param  \Zernio\Model\ConnectShopifyWithTokenRequest $connect_shopify_with_token_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function connectShopifyWithTokenAsyncWithHttpInfo($connect_shopify_with_token_request, string $contentType = self::contentTypes['connectShopifyWithToken'][0])
    {
        $returnType = '\Zernio\Model\ConnectShopifyWithToken200Response';
        $request = $this->connectShopifyWithTokenRequest($connect_shopify_with_token_request, $contentType);
    ...
    /**
     * Create request for operation 'connectShopifyWithToken'
     *
     * @param  \Zernio\Model\ConnectShopifyWithTokenRequest $connect_shopify_with_token_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectShopifyWithToken'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function connectShopifyWithTokenRequest($connect_shopify_with_token_request, string $contentType = self::contentTypes['connectShopifyWithToken'][0])
    {

        // verify the required parameter 'connect_shopify_with_token_request' is set
        if ($connect_shopify_with_token_request === null || (is_array($connect_shopify_with_token_request) && count($connect_shopify_with_token_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $connect_shopify_with_token_request when calling connectShopifyWithToken'
            );
        }


        $resourcePath = '/v1/connect/shopify/token';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($connect_shopify_with_token_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($connect_shopify_with_token_request));
            } else {
                $httpBody = $connect_shopify_with_token_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation createPinterestBoard
     *
     * Create Pinterest board
     *
     * @param  string $account_id account_id (required)
     * @param  \Zernio\Model\CreatePinterestBoardRequest $create_pinterest_board_request create_pinterest_board_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPinterestBoard'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\CreatePinterestBoard201Response|\Zernio\Model\InlineObject
     */
    public function createPinterestBoard($account_id, $create_pinterest_board_request, string $contentType = self::contentTypes['createPinterestBoard'][0])
    {
        list($response) = $this->createPinterestBoardWithHttpInfo($account_id, $create_pinterest_board_request, $contentType);
        return $response;
    }

    /**
     * Operation createPinterestBoardWithHttpInfo
     *
     * Create Pinterest board
     *
     * @param  string $account_id (required)
     * @param  \Zernio\Model\CreatePinterestBoardRequest $create_pinterest_board_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPinterestBoard'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\CreatePinterestBoard201Response|\Zernio\Model\InlineObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPinterestBoardWithHttpInfo($account_id, $create_pinterest_board_request, string $contentType = self::contentTypes['createPinterestBoard'][0])
    {
        $request = $this->createPinterestBoardRequest($account_id, $create_pinterest_board_request, $contentType);
    ...
    /**
     * Operation createPinterestBoardAsync
     *
     * Create Pinterest board
     *
     * @param  string $account_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPinterestBoardAsync($account_id, $create_pinterest_board_request, string $contentType = self::contentTypes['createPinterestBoard'][0])
    {
        return $this->createPinterestBoardAsyncWithHttpInfo($account_id, $create_pinterest_board_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createPinterestBoardAsyncWithHttpInfo
     *
     * Create Pinterest board
     *
     * @param  string $account_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPinterestBoardAsyncWithHttpInfo($account_id, $create_pinterest_board_request, string $contentType = self::contentTypes['createPinterestBoard'][0])
    {
        $returnType = '\Zernio\Model\CreatePinterestBoard201Response';
        $request = $this->createPinterestBoardRequest($account_id, $create_pinterest_board_request, $contentType);
    ...
    /**
     * Create request for operation 'createPinterestBoard'
     *
     * @param  string $account_id (required)
     * @param  \Zernio\Model\CreatePinterestBoardRequest $create_pinterest_board_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPinterestBoard'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createPinterestBoardRequest($account_id, $create_pinterest_board_request, string $contentType = self::contentTypes['createPinterestBoard'][0])
    {

        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling createPinterestBoard'
            );
        }

        // verify the required parameter 'create_pinterest_board_request' is set
        if ($create_pinterest_board_request === null || (is_array($create_pinterest_board_request) && count($create_pinterest_board_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_pinterest_board_request when calling createPinterestBoard'
            );
        }
        ...
        // for model (json/xml)
        if (isset($create_pinterest_board_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
    ...
    /**
     * Operation getShopifyConnectUrl
     *
     * Get Shopify OAuth connect URL
     *
     * @param  string $profile_id Your Zernio profile ID (get from /v1/profiles). (required)
     * @param  string $shop The myshopify.com store domain to connect, e.g. &#x60;your-store.myshopify.com&#x60; (the bare &#x60;your-store&#x60; prefix is accepted too). (required)
     * @param  string|null $redirect_url Your custom redirect URL after connection completes. MUST be an absolute http(s) URL or a custom app scheme for mobile deeplinks (e.g. myapp://callback); a relative path is rejected with 400 INVALID_REDIRECT_URL. On failure an &#x60;error&#x60; query param is appended. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getShopifyConnectUrl'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\GetConnectUrl200Response|\Zernio\Model\InlineObject|\Zernio\Model\InlineObject3
     */
    public function getShopifyConnectUrl($profile_id, $shop, $redirect_url = null, string $contentType = self::contentTypes['getShopifyConnectUrl'][0])
    {
        list($response) = $this->getShopifyConnectUrlWithHttpInfo($profile_id, $shop, $redirect_url, $contentType);
        return $response;
    }

    /**
     * Operation getShopifyConnectUrlWithHttpInfo
     *
     * Get Shopify OAuth connect URL
     *
     * @param  string $profile_id Your Zernio profile ID (get from /v1/profiles). (required)
     ...
     * @return array of \Zernio\Model\GetConnectUrl200Response|\Zernio\Model\InlineObject|\Zernio\Model\InlineObject3, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShopifyConnectUrlWithHttpInfo($profile_id, $shop, $redirect_url = null, string $contentType = self::contentTypes['getShopifyConnectUrl'][0])
    {
        $request = $this->getShopifyConnectUrlRequest($profile_id, $shop, $redirect_url, $contentType);
    ...
    /**
     * Operation getShopifyConnectUrlAsync
     *
     * Get Shopify OAuth connect URL
     *
     * @param  string $profile_id Your Zernio profile ID (get from /v1/profiles). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getShopifyConnectUrlAsync($profile_id, $shop, $redirect_url = null, string $contentType = self::contentTypes['getShopifyConnectUrl'][0])
    {
        return $this->getShopifyConnectUrlAsyncWithHttpInfo($profile_id, $shop, $redirect_url, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getShopifyConnectUrlAsyncWithHttpInfo
     *
     * Get Shopify OAuth connect URL
     *
     * @param  string $profile_id Your Zernio profile ID (get from /v1/profiles). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getShopifyConnectUrlAsyncWithHttpInfo($profile_id, $shop, $redirect_url = null, string $contentType = self::contentTypes['getShopifyConnectUrl'][0])
    {
        $returnType = '\Zernio\Model\GetConnectUrl200Response';
        $request = $this->getShopifyConnectUrlRequest($profile_id, $shop, $redirect_url, $contentType);
    ...
    /**
     * Create request for operation 'getShopifyConnectUrl'
     *
     * @param  string $profile_id Your Zernio profile ID (get from /v1/profiles). (required)
     * @param  string $shop The myshopify.com store domain to connect, e.g. &#x60;your-store.myshopify.com&#x60; (the bare &#x60;your-store&#x60; prefix is accepted too). (required)
     * @param  string|null $redirect_url Your custom redirect URL after connection completes. MUST be an absolute http(s) URL or a custom app scheme for mobile deeplinks (e.g. myapp://callback); a relative path is rejected with 400 INVALID_REDIRECT_URL. On failure an &#x60;error&#x60; query param is appended. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getShopifyConnectUrlRequest($profile_id, $shop, $redirect_url = null, string $contentType = self::contentTypes['getShopifyConnectUrl'][0])
    {

        // verify the required parameter 'profile_id' is set
        if ($profile_id === null || (is_array($profile_id) && count($profile_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $profile_id when calling getShopifyConnectUrl'
            );
        }
        ...
        if ($shop === null || (is_array($shop) && count($shop) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shop when calling getShopifyConnectUrl'
            );
        }



        $resourcePath = '/v1/connect/shopify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getSubredditRules
     *
     * Get subreddit rules
     *
     * @param  string $account_id The ID of the Reddit account (required)
     * @param  string $subreddit Subreddit name (without the \&quot;r/\&quot; prefix) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSubredditRules'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\GetSubredditRules200Response|\Zernio\Model\InlineObject
     */
    public function getSubredditRules($account_id, $subreddit, string $contentType = self::contentTypes['getSubredditRules'][0])
    {
        list($response) = $this->getSubredditRulesWithHttpInfo($account_id, $subreddit, $contentType);
        return $response;
    }

    /**
     * Operation getSubredditRulesWithHttpInfo
     *
     * Get subreddit rules
     *
     * @param  string $account_id The ID of the Reddit account (required)
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\GetSubredditRules200Response|\Zernio\Model\InlineObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubredditRulesWithHttpInfo($account_id, $subreddit, string $contentType = self::contentTypes['getSubredditRules'][0])
    {
        $request = $this->getSubredditRulesRequest($account_id, $subreddit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\GetSubredditRules200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation getSubredditRulesAsync
     *
     * Get subreddit rules
     *
     * @param  string $account_id The ID of the Reddit account (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubredditRulesAsync($account_id, $subreddit, string $contentType = self::contentTypes['getSubredditRules'][0])
    {
        return $this->getSubredditRulesAsyncWithHttpInfo($account_id, $subreddit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSubredditRulesAsyncWithHttpInfo
     *
     * Get subreddit rules
     *
     * @param  string $account_id The ID of the Reddit account (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubredditRulesAsyncWithHttpInfo($account_id, $subreddit, string $contentType = self::contentTypes['getSubredditRules'][0])
    {
        $returnType = '\Zernio\Model\GetSubredditRules200Response';
        $request = $this->getSubredditRulesRequest($account_id, $subreddit, $contentType);
    ...
    /**
     * Create request for operation 'getSubredditRules'
     *
     * @param  string $account_id The ID of the Reddit account (required)
     * @param  string $subreddit Subreddit name (without the \&quot;r/\&quot; prefix) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSubredditRules'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSubredditRulesRequest($account_id, $subreddit, string $contentType = self::contentTypes['getSubredditRules'][0])
    {

        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling getSubredditRules'
            );
        }
        ...
        if ($subreddit === null || (is_array($subreddit) && count($subreddit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subreddit when calling getSubredditRules'
            );
        }


        $resourcePath = '/v1/accounts/{accountId}/reddit-subreddits/{subreddit}/rules';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string|null $x_connect_token Alternative auth for API users&#39; end customers (used when the bearer token is scoped to a different user) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listWhatsAppPhoneNumbers'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\ListWhatsAppPhoneNumbers200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject|\Zernio\Model\ErrorResponse
     */
    public function listWhatsAppPhoneNumbers($profile_id, $temp_token, $x_connect_token = null, string $contentType = self::contentTypes['listWhatsAppPhoneNumbers'][0])
    {
        list($response) = $this->listWhatsAppPhoneNumbersWithHttpInfo($profile_id, $temp_token, $x_connect_token, $contentType);
        return $response;
    }
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\ListWhatsAppPhoneNumbers200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject|\Zernio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listWhatsAppPhoneNumbersWithHttpInfo($profile_id, $temp_token, $x_connect_token = null, string $contentType = self::contentTypes['listWhatsAppPhoneNumbers'][0])
    {
        $request = $this->listWhatsAppPhoneNumbersRequest($profile_id, $temp_token, $x_connect_token, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\ListWhatsAppPhoneNumbers200Response',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listWhatsAppPhoneNumbersAsync($profile_id, $temp_token, $x_connect_token = null, string $contentType = self::contentTypes['listWhatsAppPhoneNumbers'][0])
    {
        return $this->listWhatsAppPhoneNumbersAsyncWithHttpInfo($profile_id, $temp_token, $x_connect_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listWhatsAppPhoneNumbersAsyncWithHttpInfo($profile_id, $temp_token, $x_connect_token = null, string $contentType = self::contentTypes['listWhatsAppPhoneNumbers'][0])
    {
        $returnType = '\Zernio\Model\ListWhatsAppPhoneNumbers200Response';
        $request = $this->listWhatsAppPhoneNumbersRequest($profile_id, $temp_token, $x_connect_token, $contentType);
    ...
    /**
     * Create request for operation 'listWhatsAppPhoneNumbers'
     *
     * @param  string $profile_id The Zernio profile ID from the headless redirect (required)
     * @param  string $temp_token The temporary access token from the headless redirect (required)
     * @param  string|null $x_connect_token Alternative auth for API users&#39; end customers (used when the bearer token is scoped to a different user) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listWhatsAppPhoneNumbersRequest($profile_id, $temp_token, $x_connect_token = null, string $contentType = self::contentTypes['listWhatsAppPhoneNumbers'][0])
    {

        // verify the required parameter 'profile_id' is set
        if ($profile_id === null || (is_array($profile_id) && count($profile_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $profile_id when calling listWhatsAppPhoneNumbers'
            );
        }
        ...
        if ($temp_token === null || (is_array($temp_token) && count($temp_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $temp_token when calling listWhatsAppPhoneNumbers'
            );
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setRedditPostFlair'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\UpdateYoutubeDefaultPlaylist200Response|\Zernio\Model\InlineObject
     */
    public function setRedditPostFlair($account_id, $set_reddit_post_flair_request, string $contentType = self::contentTypes['setRedditPostFlair'][0])
    {
        list($response) = $this->setRedditPostFlairWithHttpInfo($account_id, $set_reddit_post_flair_request, $contentType);
        return $response;
    }
     ...
     */
    public function setRedditPostFlairWithHttpInfo($account_id, $set_reddit_post_flair_request, string $contentType = self::contentTypes['setRedditPostFlair'][0])
    {
        $request = $this->setRedditPostFlairRequest($account_id, $set_reddit_post_flair_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setRedditPostFlairAsync($account_id, $set_reddit_post_flair_request, string $contentType = self::contentTypes['setRedditPostFlair'][0])
    {
        return $this->setRedditPostFlairAsyncWithHttpInfo($account_id, $set_reddit_post_flair_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setRedditPostFlairAsyncWithHttpInfo($account_id, $set_reddit_post_flair_request, string $contentType = self::contentTypes['setRedditPostFlair'][0])
    {
    ...
    /**
     * Create request for operation 'setRedditPostFlair'
     *
     * @param  string $account_id The ID of the Reddit account that owns the post (required)
     * @param  \Zernio\Model\SetRedditPostFlairRequest $set_reddit_post_flair_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setRedditPostFlair'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setRedditPostFlairRequest($account_id, $set_reddit_post_flair_request, string $contentType = self::contentTypes['setRedditPostFlair'][0])
    {

        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling setRedditPostFlair'
            );
        }

        // verify the required parameter 'set_reddit_post_flair_request' is set
        if ($set_reddit_post_flair_request === null || (is_array($set_reddit_post_flair_request) && count($set_reddit_post_flair_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $set_reddit_post_flair_request when calling setRedditPostFlair'
            );
        }
        ...
        // for model (json/xml)
        if (isset($set_reddit_post_flair_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($set_reddit_post_flair_request));
            } else {
                $httpBody = $set_reddit_post_flair_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation voteRedditThing
     *
     * Vote on a Reddit post or comment
     *
     * @param  string $account_id The ID of the Reddit account casting the vote (required)
     * @param  \Zernio\Model\VoteRedditThingRequest $vote_reddit_thing_request vote_reddit_thing_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['voteRedditThing'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\UpdateYoutubeDefaultPlaylist200Response|\Zernio\Model\InlineObject
     */
    public function voteRedditThing($account_id, $vote_reddit_thing_request, string $contentType = self::contentTypes['voteRedditThing'][0])
    {
        list($response) = $this->voteRedditThingWithHttpInfo($account_id, $vote_reddit_thing_request, $contentType);
        return $response;
    }

    /**
     * Operation voteRedditThingWithHttpInfo
     *
     * Vote on a Reddit post or comment
     *
     * @param  string $account_id The ID of the Reddit account casting the vote (required)
     * @param  \Zernio\Model\VoteRedditThingRequest $vote_reddit_thing_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['voteRedditThing'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\UpdateYoutubeDefaultPlaylist200Response|\Zernio\Model\InlineObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function voteRedditThingWithHttpInfo($account_id, $vote_reddit_thing_request, string $contentType = self::contentTypes['voteRedditThing'][0])
    {
        $request = $this->voteRedditThingRequest($account_id, $vote_reddit_thing_request, $contentType);
    ...
    /**
     * Operation voteRedditThingAsync
     *
     * Vote on a Reddit post or comment
     *
     * @param  string $account_id The ID of the Reddit account casting the vote (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voteRedditThingAsync($account_id, $vote_reddit_thing_request, string $contentType = self::contentTypes['voteRedditThing'][0])
    {
        return $this->voteRedditThingAsyncWithHttpInfo($account_id, $vote_reddit_thing_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation voteRedditThingAsyncWithHttpInfo
     *
     * Vote on a Reddit post or comment
     *
     * @param  string $account_id The ID of the Reddit account casting the vote (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voteRedditThingAsyncWithHttpInfo($account_id, $vote_reddit_thing_request, string $contentType = self::contentTypes['voteRedditThing'][0])
    {
        $returnType = '\Zernio\Model\UpdateYoutubeDefaultPlaylist200Response';
        $request = $this->voteRedditThingRequest($account_id, $vote_reddit_thing_request, $contentType);
    ...
    /**
     * Create request for operation 'voteRedditThing'
     *
     * @param  string $account_id The ID of the Reddit account casting the vote (required)
     * @param  \Zernio\Model\VoteRedditThingRequest $vote_reddit_thing_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['voteRedditThing'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function voteRedditThingRequest($account_id, $vote_reddit_thing_request, string $contentType = self::contentTypes['voteRedditThing'][0])
    {

        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling voteRedditThing'
            );
        }

        // verify the required parameter 'vote_reddit_thing_request' is set
        if ($vote_reddit_thing_request === null || (is_array($vote_reddit_thing_request) && count($vote_reddit_thing_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $vote_reddit_thing_request when calling voteRedditThing'
            );
        }


        $resourcePath = '/v1/accounts/{accountId}/reddit-vote';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($vote_reddit_thing_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($vote_reddit_thing_request));
            } else {
                $httpBody = $vote_reddit_thing_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

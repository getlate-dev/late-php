...
class WebhookEventsApi
{
    ...
    /**
     * Operation onAnalyticsSynced
     *
     * Analytics synced event
     *
     * @param  \Zernio\Model\WebhookPayloadAnalyticsSynced $webhook_payload_analytics_synced webhook_payload_analytics_synced (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onAnalyticsSynced'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function onAnalyticsSynced($webhook_payload_analytics_synced, string $contentType = self::contentTypes['onAnalyticsSynced'][0])
    {
        $this->onAnalyticsSyncedWithHttpInfo($webhook_payload_analytics_synced, $contentType);
    }

    /**
     * Operation onAnalyticsSyncedWithHttpInfo
     *
     * Analytics synced event
     *
     * @param  \Zernio\Model\WebhookPayloadAnalyticsSynced $webhook_payload_analytics_synced (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onAnalyticsSynced'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function onAnalyticsSyncedWithHttpInfo($webhook_payload_analytics_synced, string $contentType = self::contentTypes['onAnalyticsSynced'][0])
    {
        $request = $this->onAnalyticsSyncedRequest($webhook_payload_analytics_synced, $contentType);
    ...
    /**
     * Operation onAnalyticsSyncedAsync
     *
     * Analytics synced event
     *
     * @param  \Zernio\Model\WebhookPayloadAnalyticsSynced $webhook_payload_analytics_synced (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onAnalyticsSyncedAsync($webhook_payload_analytics_synced, string $contentType = self::contentTypes['onAnalyticsSynced'][0])
    {
        return $this->onAnalyticsSyncedAsyncWithHttpInfo($webhook_payload_analytics_synced, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation onAnalyticsSyncedAsyncWithHttpInfo
     *
     * Analytics synced event
     *
     * @param  \Zernio\Model\WebhookPayloadAnalyticsSynced $webhook_payload_analytics_synced (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onAnalyticsSyncedAsyncWithHttpInfo($webhook_payload_analytics_synced, string $contentType = self::contentTypes['onAnalyticsSynced'][0])
    {
        $returnType = '';
        $request = $this->onAnalyticsSyncedRequest($webhook_payload_analytics_synced, $contentType);
    ...
    /**
     * Create request for operation 'onAnalyticsSynced'
     *
     * @param  \Zernio\Model\WebhookPayloadAnalyticsSynced $webhook_payload_analytics_synced (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onAnalyticsSynced'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function onAnalyticsSyncedRequest($webhook_payload_analytics_synced, string $contentType = self::contentTypes['onAnalyticsSynced'][0])
    {

        // verify the required parameter 'webhook_payload_analytics_synced' is set
        if ($webhook_payload_analytics_synced === null || (is_array($webhook_payload_analytics_synced) && count($webhook_payload_analytics_synced) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_payload_analytics_synced when calling onAnalyticsSynced'
            );
        }


        $resourcePath = '/analytics.synced';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($webhook_payload_analytics_synced)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_payload_analytics_synced));
            } else {
                $httpBody = $webhook_payload_analytics_synced;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation onPostPlatformDeleted
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onPostPlatformDeleted'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function onPostPlatformDeleted($webhook_payload_post_platform, string $contentType = self::contentTypes['onPostPlatformDeleted'][0])
    {
        $this->onPostPlatformDeletedWithHttpInfo($webhook_payload_post_platform, $contentType);
    }

    /**
     * Operation onPostPlatformDeletedWithHttpInfo
     *
     * Post platform deleted event
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function onPostPlatformDeletedWithHttpInfo($webhook_payload_post_platform, string $contentType = self::contentTypes['onPostPlatformDeleted'][0])
    {
        $request = $this->onPostPlatformDeletedRequest($webhook_payload_post_platform, $contentType);
    ...
    /**
     * Operation onPostPlatformDeletedAsync
     *
     * Post platform deleted event
     *
     * @param  \Zernio\Model\WebhookPayloadPostPlatform $webhook_payload_post_platform (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onPostPlatformDeletedAsync($webhook_payload_post_platform, string $contentType = self::contentTypes['onPostPlatformDeleted'][0])
    {
        return $this->onPostPlatformDeletedAsyncWithHttpInfo($webhook_payload_post_platform, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation onPostPlatformDeletedAsyncWithHttpInfo
     *
     * Post platform deleted event
     *
     * @param  \Zernio\Model\WebhookPayloadPostPlatform $webhook_payload_post_platform (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onPostPlatformDeletedAsyncWithHttpInfo($webhook_payload_post_platform, string $contentType = self::contentTypes['onPostPlatformDeleted'][0])
    {
        $returnType = '';
        $request = $this->onPostPlatformDeletedRequest($webhook_payload_post_platform, $contentType);
    ...
    /**
     * Create request for operation 'onPostPlatformDeleted'
     *
     * @param  \Zernio\Model\WebhookPayloadPostPlatform $webhook_payload_post_platform (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onPostPlatformDeleted'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function onPostPlatformDeletedRequest($webhook_payload_post_platform, string $contentType = self::contentTypes['onPostPlatformDeleted'][0])
    {
        ...
        if ($webhook_payload_post_platform === null || (is_array($webhook_payload_post_platform) && count($webhook_payload_post_platform) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_payload_post_platform when calling onPostPlatformDeleted'
            );
        }


        $resourcePath = '/post.platform.deleted';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation onReferralReceived
     *
     * Referral received event
     *
     * @param  \Zernio\Model\WebhookPayloadReferral $webhook_payload_referral webhook_payload_referral (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onReferralReceived'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function onReferralReceived($webhook_payload_referral, string $contentType = self::contentTypes['onReferralReceived'][0])
    {
        $this->onReferralReceivedWithHttpInfo($webhook_payload_referral, $contentType);
    }

    /**
     * Operation onReferralReceivedWithHttpInfo
     *
     * Referral received event
     *
     * @param  \Zernio\Model\WebhookPayloadReferral $webhook_payload_referral (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onReferralReceived'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function onReferralReceivedWithHttpInfo($webhook_payload_referral, string $contentType = self::contentTypes['onReferralReceived'][0])
    {
        $request = $this->onReferralReceivedRequest($webhook_payload_referral, $contentType);
    ...
    /**
     * Operation onReferralReceivedAsync
     *
     * Referral received event
     *
     * @param  \Zernio\Model\WebhookPayloadReferral $webhook_payload_referral (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onReferralReceivedAsync($webhook_payload_referral, string $contentType = self::contentTypes['onReferralReceived'][0])
    {
        return $this->onReferralReceivedAsyncWithHttpInfo($webhook_payload_referral, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation onReferralReceivedAsyncWithHttpInfo
     *
     * Referral received event
     *
     * @param  \Zernio\Model\WebhookPayloadReferral $webhook_payload_referral (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onReferralReceivedAsyncWithHttpInfo($webhook_payload_referral, string $contentType = self::contentTypes['onReferralReceived'][0])
    {
        $returnType = '';
        $request = $this->onReferralReceivedRequest($webhook_payload_referral, $contentType);
    ...
    /**
     * Create request for operation 'onReferralReceived'
     *
     * @param  \Zernio\Model\WebhookPayloadReferral $webhook_payload_referral (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onReferralReceived'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function onReferralReceivedRequest($webhook_payload_referral, string $contentType = self::contentTypes['onReferralReceived'][0])
    {

        // verify the required parameter 'webhook_payload_referral' is set
        if ($webhook_payload_referral === null || (is_array($webhook_payload_referral) && count($webhook_payload_referral) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_payload_referral when calling onReferralReceived'
            );
        }


        $resourcePath = '/referral.received';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($webhook_payload_referral)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_payload_referral));
            } else {
                $httpBody = $webhook_payload_referral;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation onWhatsAppAccountNameStatusUpdated
     *
     * WhatsApp display-name review outcome event
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppAccountNameStatusUpdated $webhook_payload_whats_app_account_name_status_updated webhook_payload_whats_app_account_name_status_updated (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onWhatsAppAccountNameStatusUpdated'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function onWhatsAppAccountNameStatusUpdated($webhook_payload_whats_app_account_name_status_updated, string $contentType = self::contentTypes['onWhatsAppAccountNameStatusUpdated'][0])
    {
        $this->onWhatsAppAccountNameStatusUpdatedWithHttpInfo($webhook_payload_whats_app_account_name_status_updated, $contentType);
    }

    /**
     * Operation onWhatsAppAccountNameStatusUpdatedWithHttpInfo
     *
     * WhatsApp display-name review outcome event
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppAccountNameStatusUpdated $webhook_payload_whats_app_account_name_status_updated (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onWhatsAppAccountNameStatusUpdated'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function onWhatsAppAccountNameStatusUpdatedWithHttpInfo($webhook_payload_whats_app_account_name_status_updated, string $contentType = self::contentTypes['onWhatsAppAccountNameStatusUpdated'][0])
    {
        $request = $this->onWhatsAppAccountNameStatusUpdatedRequest($webhook_payload_whats_app_account_name_status_updated, $contentType);
    ...
    /**
     * Operation onWhatsAppAccountNameStatusUpdatedAsync
     *
     * WhatsApp display-name review outcome event
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppAccountNameStatusUpdated $webhook_payload_whats_app_account_name_status_updated (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onWhatsAppAccountNameStatusUpdatedAsync($webhook_payload_whats_app_account_name_status_updated, string $contentType = self::contentTypes['onWhatsAppAccountNameStatusUpdated'][0])
    {
        return $this->onWhatsAppAccountNameStatusUpdatedAsyncWithHttpInfo($webhook_payload_whats_app_account_name_status_updated, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation onWhatsAppAccountNameStatusUpdatedAsyncWithHttpInfo
     *
     * WhatsApp display-name review outcome event
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppAccountNameStatusUpdated $webhook_payload_whats_app_account_name_status_updated (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onWhatsAppAccountNameStatusUpdatedAsyncWithHttpInfo($webhook_payload_whats_app_account_name_status_updated, string $contentType = self::contentTypes['onWhatsAppAccountNameStatusUpdated'][0])
    {
        $returnType = '';
        $request = $this->onWhatsAppAccountNameStatusUpdatedRequest($webhook_payload_whats_app_account_name_status_updated, $contentType);
    ...
    /**
     * Create request for operation 'onWhatsAppAccountNameStatusUpdated'
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppAccountNameStatusUpdated $webhook_payload_whats_app_account_name_status_updated (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onWhatsAppAccountNameStatusUpdated'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function onWhatsAppAccountNameStatusUpdatedRequest($webhook_payload_whats_app_account_name_status_updated, string $contentType = self::contentTypes['onWhatsAppAccountNameStatusUpdated'][0])
    {

        // verify the required parameter 'webhook_payload_whats_app_account_name_status_updated' is set
        if ($webhook_payload_whats_app_account_name_status_updated === null || (is_array($webhook_payload_whats_app_account_name_status_updated) && count($webhook_payload_whats_app_account_name_status_updated) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_payload_whats_app_account_name_status_updated when calling onWhatsAppAccountNameStatusUpdated'
            );
        }


        $resourcePath = '/whatsapp.account.name_status_updated';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($webhook_payload_whats_app_account_name_status_updated)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_payload_whats_app_account_name_status_updated));
            } else {
                $httpBody = $webhook_payload_whats_app_account_name_status_updated;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation onWhatsAppTemplateCategoryUpdated
     *
     * WhatsApp template category updated event
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppTemplateCategoryUpdated $webhook_payload_whats_app_template_category_updated webhook_payload_whats_app_template_category_updated (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onWhatsAppTemplateCategoryUpdated'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function onWhatsAppTemplateCategoryUpdated($webhook_payload_whats_app_template_category_updated, string $contentType = self::contentTypes['onWhatsAppTemplateCategoryUpdated'][0])
    {
        $this->onWhatsAppTemplateCategoryUpdatedWithHttpInfo($webhook_payload_whats_app_template_category_updated, $contentType);
    }

    /**
     * Operation onWhatsAppTemplateCategoryUpdatedWithHttpInfo
     *
     * WhatsApp template category updated event
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppTemplateCategoryUpdated $webhook_payload_whats_app_template_category_updated (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onWhatsAppTemplateCategoryUpdated'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function onWhatsAppTemplateCategoryUpdatedWithHttpInfo($webhook_payload_whats_app_template_category_updated, string $contentType = self::contentTypes['onWhatsAppTemplateCategoryUpdated'][0])
    {
        $request = $this->onWhatsAppTemplateCategoryUpdatedRequest($webhook_payload_whats_app_template_category_updated, $contentType);
    ...
    /**
     * Operation onWhatsAppTemplateCategoryUpdatedAsync
     *
     * WhatsApp template category updated event
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppTemplateCategoryUpdated $webhook_payload_whats_app_template_category_updated (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onWhatsAppTemplateCategoryUpdatedAsync($webhook_payload_whats_app_template_category_updated, string $contentType = self::contentTypes['onWhatsAppTemplateCategoryUpdated'][0])
    {
        return $this->onWhatsAppTemplateCategoryUpdatedAsyncWithHttpInfo($webhook_payload_whats_app_template_category_updated, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation onWhatsAppTemplateCategoryUpdatedAsyncWithHttpInfo
     *
     * WhatsApp template category updated event
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppTemplateCategoryUpdated $webhook_payload_whats_app_template_category_updated (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function onWhatsAppTemplateCategoryUpdatedAsyncWithHttpInfo($webhook_payload_whats_app_template_category_updated, string $contentType = self::contentTypes['onWhatsAppTemplateCategoryUpdated'][0])
    {
        $returnType = '';
        $request = $this->onWhatsAppTemplateCategoryUpdatedRequest($webhook_payload_whats_app_template_category_updated, $contentType);
    ...
    /**
     * Create request for operation 'onWhatsAppTemplateCategoryUpdated'
     *
     * @param  \Zernio\Model\WebhookPayloadWhatsAppTemplateCategoryUpdated $webhook_payload_whats_app_template_category_updated (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['onWhatsAppTemplateCategoryUpdated'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function onWhatsAppTemplateCategoryUpdatedRequest($webhook_payload_whats_app_template_category_updated, string $contentType = self::contentTypes['onWhatsAppTemplateCategoryUpdated'][0])
    {

        // verify the required parameter 'webhook_payload_whats_app_template_category_updated' is set
        if ($webhook_payload_whats_app_template_category_updated === null || (is_array($webhook_payload_whats_app_template_category_updated) && count($webhook_payload_whats_app_template_category_updated) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_payload_whats_app_template_category_updated when calling onWhatsAppTemplateCategoryUpdated'
            );
        }


        $resourcePath = '/whatsapp.template.category_updated';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($webhook_payload_whats_app_template_category_updated)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_payload_whats_app_template_category_updated));
            } else {
                $httpBody = $webhook_payload_whats_app_template_category_updated;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

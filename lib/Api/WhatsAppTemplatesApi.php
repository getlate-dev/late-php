...
class WhatsAppTemplatesApi
{
    ...
    /**
     * Operation getWhatsAppLibraryTemplate
     *
    ...
    /**
     * Operation getWhatsAppLibraryTemplateWithHttpInfo
     *
     * Look up a library template
     *
     * @param  string $account_id WhatsApp social account ID (required)
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\GetWhatsAppLibraryTemplate200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation getWhatsAppLibraryTemplateAsync
     *
     * Look up a library template
     *
     * @param  string $account_id WhatsApp social account ID (required)
    ...
    /**
     * Operation getWhatsAppLibraryTemplateAsyncWithHttpInfo
     *
     * Look up a library template
     *
     * @param  string $account_id WhatsApp social account ID (required)
    ...
    public function getWhatsAppLibraryTemplateRequest($account_id, $name, string $contentType = self::contentTypes['getWhatsAppLibraryTemplate'][0])
    {
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling getWhatsAppLibraryTemplate'
            );
        }

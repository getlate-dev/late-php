...
class AnalyticsApi
{
     ...
     * @param  string|null $sort_by Sort by date, engagement, or a specific metric. Instagram-only metrics (follows, reposts, reels_skip_rate, ig_reels_*) sort a null value as 0. (optional, default to 'date')
    ...
    /**
     * Operation getYouTubeVideoRetention
     *
    ...
    {
        list($response) = $this->getYouTubeVideoRetentionWithHttpInfo($video_id, $account_id, $start_date, $end_date, $contentType);
        return $response;
    }

    /**
     * Operation getYouTubeVideoRetentionWithHttpInfo
     *
     * Get YouTube video retention curve
     *
     * @param  string $video_id The YouTube video ID (e.g., \&quot;dQw4w9WgXcQ\&quot;) (required)
    ...
    {
        $request = $this->getYouTubeVideoRetentionRequest($video_id, $account_id, $start_date, $end_date, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 404:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\GetYouTubeVideoRetention404Response',
                        $request,
                        $response,
                    );
                case 412:
    ...
    /**
     * Operation getYouTubeVideoRetentionAsync
     *
     * Get YouTube video retention curve
     *
     * @param  string $video_id The YouTube video ID (e.g., \&quot;dQw4w9WgXcQ\&quot;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getYouTubeVideoRetentionAsync($video_id, $account_id, $start_date = null, $end_date = null, string $contentType = self::contentTypes['getYouTubeVideoRetention'][0])
    {
        return $this->getYouTubeVideoRetentionAsyncWithHttpInfo($video_id, $account_id, $start_date, $end_date, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getYouTubeVideoRetentionAsyncWithHttpInfo
     *
     * Get YouTube video retention curve
     *
     * @param  string $video_id The YouTube video ID (e.g., \&quot;dQw4w9WgXcQ\&quot;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getYouTubeVideoRetentionAsyncWithHttpInfo($video_id, $account_id, $start_date = null, $end_date = null, string $contentType = self::contentTypes['getYouTubeVideoRetention'][0])
    {
        $returnType = '\Zernio\Model\YouTubeVideoRetentionResponse';
        $request = $this->getYouTubeVideoRetentionRequest($video_id, $account_id, $start_date, $end_date, $contentType);
    ...
    /**
     * Create request for operation 'getYouTubeVideoRetention'
     *
     * @param  string $video_id The YouTube video ID (e.g., \&quot;dQw4w9WgXcQ\&quot;) (required)
     * @param  string $account_id The Zernio account ID for the YouTube account (required)
     * @param  \DateTime|null $start_date Start date (YYYY-MM-DD). Defaults to the video&#39;s publish date (lifetime curve). (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getYouTubeVideoRetentionRequest($video_id, $account_id, $start_date = null, $end_date = null, string $contentType = self::contentTypes['getYouTubeVideoRetention'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling getYouTubeVideoRetention'
            );
        }
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling getYouTubeVideoRetention'
            );
        }
        ...
        $resourcePath = '/v1/analytics/youtube/video-retention';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\SyncExternalPosts200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\ErrorResponse
     */
    public function syncExternalPosts($sync_external_posts_request, string $contentType = self::contentTypes['syncExternalPosts'][0])
    {
        list($response) = $this->syncExternalPostsWithHttpInfo($sync_external_posts_request, $contentType);
        return $response;
    }
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\SyncExternalPosts200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncExternalPostsWithHttpInfo($sync_external_posts_request, string $contentType = self::contentTypes['syncExternalPosts'][0])
    {
        $request = $this->syncExternalPostsRequest($sync_external_posts_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncExternalPostsAsync($sync_external_posts_request, string $contentType = self::contentTypes['syncExternalPosts'][0])
    {
        return $this->syncExternalPostsAsyncWithHttpInfo($sync_external_posts_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncExternalPostsAsyncWithHttpInfo($sync_external_posts_request, string $contentType = self::contentTypes['syncExternalPosts'][0])
    {
        $returnType = '\Zernio\Model\SyncExternalPosts200Response';
        $request = $this->syncExternalPostsRequest($sync_external_posts_request, $contentType);
    ...
    /**
     * Create request for operation 'syncExternalPosts'
     *
     * @param  \Zernio\Model\SyncExternalPostsRequest $sync_external_posts_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['syncExternalPosts'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function syncExternalPostsRequest($sync_external_posts_request, string $contentType = self::contentTypes['syncExternalPosts'][0])
    {

        // verify the required parameter 'sync_external_posts_request' is set
        if ($sync_external_posts_request === null || (is_array($sync_external_posts_request) && count($sync_external_posts_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sync_external_posts_request when calling syncExternalPosts'
            );
        }


        $resourcePath = '/v1/posts/sync-external';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($sync_external_posts_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($sync_external_posts_request));
            } else {
                $httpBody = $sync_external_posts_request;
            }

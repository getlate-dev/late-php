...
class AccountGroupsApi
{
    ...
    {
        list($response) = $this->createAccountGroupWithHttpInfo($create_account_group_request, $contentType);
        return $response;
    }
     ...
     */
    public function createAccountGroupAsync($create_account_group_request, string $contentType = self::contentTypes['createAccountGroup'][0])
    {
        return $this->createAccountGroupAsyncWithHttpInfo($create_account_group_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createAccountGroupRequest($create_account_group_request, string $contentType = self::contentTypes['createAccountGroup'][0])
    {

        // verify the required parameter 'create_account_group_request' is set
        if ($create_account_group_request === null || (is_array($create_account_group_request) && count($create_account_group_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_account_group_request when calling createAccountGroup'
            );
        }


        $resourcePath = '/v1/account-groups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_account_group_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_account_group_request));
            } else {
                $httpBody = $create_account_group_request;
            }
    ...
    {
        list($response) = $this->deleteAccountGroupWithHttpInfo($group_id, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAccountGroupAsync($group_id, string $contentType = self::contentTypes['deleteAccountGroup'][0])
    {
        return $this->deleteAccountGroupAsyncWithHttpInfo($group_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteAccountGroupRequest($group_id, string $contentType = self::contentTypes['deleteAccountGroup'][0])
    {

        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group_id when calling deleteAccountGroup'
            );
        }


        $resourcePath = '/v1/account-groups/{groupId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->listAccountGroupsWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAccountGroupsAsync(string $contentType = self::contentTypes['listAccountGroups'][0])
    {
        return $this->listAccountGroupsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Create request for operation 'listAccountGroups'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listAccountGroups'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listAccountGroupsRequest(string $contentType = self::contentTypes['listAccountGroups'][0])
    {
    ...
    {
        list($response) = $this->updateAccountGroupWithHttpInfo($group_id, $update_account_group_request, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAccountGroupAsync($group_id, $update_account_group_request, string $contentType = self::contentTypes['updateAccountGroup'][0])
    {
        return $this->updateAccountGroupAsyncWithHttpInfo($group_id, $update_account_group_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateAccountGroupRequest($group_id, $update_account_group_request, string $contentType = self::contentTypes['updateAccountGroup'][0])
    {

        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group_id when calling updateAccountGroup'
            );
        }

        // verify the required parameter 'update_account_group_request' is set
        if ($update_account_group_request === null || (is_array($update_account_group_request) && count($update_account_group_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_account_group_request when calling updateAccountGroup'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_account_group_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_account_group_request));
            } else {
                $httpBody = $update_account_group_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

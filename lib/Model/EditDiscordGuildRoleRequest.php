...
/**
 * EditDiscordGuildRoleRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class EditDiscordGuildRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'editDiscordGuildRole_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EditDiscordGuildRoleRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EditDiscordGuildRoleRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setColor($color)
    {
        ...
        if (($color > 16777215)) {
            throw new \InvalidArgumentException('invalid value for $color when calling EditDiscordGuildRoleRequest., must be smaller than or equal to 16777215.');
        }
        if (($color < 0)) {
            throw new \InvalidArgumentException('invalid value for $color when calling EditDiscordGuildRoleRequest., must be bigger than or equal to 0.');
        }

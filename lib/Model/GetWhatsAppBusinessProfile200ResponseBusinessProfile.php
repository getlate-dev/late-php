...
/**
 * GetWhatsAppBusinessProfile200ResponseBusinessProfile Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class GetWhatsAppBusinessProfile200ResponseBusinessProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getWhatsAppBusinessProfile_200_response_businessProfile';
    ...
    */
     ...
     * Sets about
     *
     * @param string|null $about Short description (max 139 chars)
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Full description (max 512 chars)
     *
     * @return self
     */
    ...
    public function setWebsites($websites)
    {
        ...
        if ((count($websites) > 2)) {
            throw new \InvalidArgumentException('invalid value for $websites when calling GetWhatsAppBusinessProfile200ResponseBusinessProfile., number of items must be less than or equal to 2.');
        }
     ...
     * Sets vertical
     *
     * @param string|null $vertical Business category
     *
     * @return self
     */

...
/**
 * OnWhatsAppNumberSuspendedRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class OnWhatsAppNumberSuspendedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'onWhatsAppNumberSuspended_request';
    ...
    public const EVENT_WHATSAPP_NUMBER_SUSPENDED = 'whatsapp.number.suspended';
    ...
    {
        return [
            self::EVENT_WHATSAPP_NUMBER_SUSPENDED,
        ];
    }

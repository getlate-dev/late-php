...
/**
 * GetLinkedInPostReactions200ResponsePagination Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class GetLinkedInPostReactions200ResponsePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getLinkedInPostReactions_200_response_pagination';
    ...
    */
     ...
     * Sets cursor
     *
     * @param string|null $cursor Offset for next page
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Total number of reactions (when available)
     *
     * @return self
     */

...
/**
 * UsageMeteringPeriod Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UsageMeteringPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsageMetering_period';
    ...
    */
     ...
     * Sets source
     *
     * @param string|null $source `cycle` = a real billing period resolved; `window` = trailing/custom window (or cycle fallback).
     *
     * @return self
     */

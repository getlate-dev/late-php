 ...
 */
class WebhookPayloadTest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookPayloadTest';
    ...
    */
     ...
     * Sets message
     *
     * @param string $message Human-readable test message
     *
     * @return self
     */

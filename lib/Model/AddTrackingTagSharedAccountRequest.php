...
/**
 * AddTrackingTagSharedAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AddTrackingTagSharedAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addTrackingTagSharedAccount_request';
    ...
    */
     ...
     * Sets ad_account_id
     *
     * @param string $ad_account_id Ad account to share with, e.g. `act_123456789`.
     *
     * @return self
     */

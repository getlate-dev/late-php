...
/**
 * PlatformAnalyticsAccountMetrics Class Doc Comment
 *
 * @category Class
 * @package  Late
 * @author   OpenAPI Generator team
 ...
 */
class PlatformAnalyticsAccountMetrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlatformAnalytics_accountMetrics';
    ...
    */
     ...
     * Sets followers
     *
     * @param int|null $followers Followers/fans count (e.g., Instagram, Facebook Pages, Twitter)
     *
     * @return self
     */
     ...
     * Sets subscribers
     *
     * @param int|null $subscribers Subscribers count (e.g., YouTube)
     *
     * @return self
     */

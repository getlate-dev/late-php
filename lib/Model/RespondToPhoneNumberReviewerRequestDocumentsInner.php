...
/**
 * RespondToPhoneNumberReviewerRequestDocumentsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class RespondToPhoneNumberReviewerRequestDocumentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'respondToPhoneNumberReviewer_request_documents_inner';
    ...
    */
     ...
     * Sets base64
     *
     * @param string|null $base64 Base64-encoded file bytes (or supply documentId instead).
     *
     * @return self
     */
     ...
     * Sets document_id
     *
     * @param string|null $document_id Id of a document already uploaded out-of-band.
     *
     * @return self
     */

 ...
 */
class TriggerWorkflowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'triggerWorkflow_request';
    ...
    */
     ...
     * Sets to
     *
     * @param string|null $to Recipient phone (WhatsApp only)
     *
     * @return self
     */
     ...
     *
     * @param string|null $conversation_id An existing conversation to run in (required for non-WhatsApp workflows)
     *
     * @return self
     */

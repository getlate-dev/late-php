...
/**
 * PostLogDetail Class Doc Comment
 *
 * @category Class
 * @package  Late
 * @author   OpenAPI Generator team
 ...
 */
class PostLogDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostLogDetail';
    ...
    protected static $openAPITypes = [
        '_id' => 'string',
        'post_id' => '\Late\Model\PostLogDetailAllOfPostId',
        'user_id' => 'string',
        'profile_id' => 'string',
        'platform' => 'string',
        'account_id' => '\Late\Model\PostLogDetailAllOfAccountId',
    ...
    */
     ...
     * Gets post_id
     *
     * @return \Late\Model\PostLogDetailAllOfPostId|null
     */
     ...
     * Sets post_id
     *
     * @param \Late\Model\PostLogDetailAllOfPostId|null $post_id post_id
     *
     * @return self
     */
     ...
     * Gets account_id
     *
     * @return \Late\Model\PostLogDetailAllOfAccountId|null
     */
     ...
     * Sets account_id
     *
     * @param \Late\Model\PostLogDetailAllOfAccountId|null $account_id account_id
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Type of action logged: - `publish` - Initial publish attempt - `retry` - Retry after failure - `media_upload` - Media upload step - `rate_limit_pause` - Account paused due to rate limits - `token_refresh` - Token was refreshed - `cancelled` - Post was cancelled
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata Additional metadata (e.g., rate limit info)
     *
     * @return self
     */

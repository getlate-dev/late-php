...
/**
 * WebhookPayloadCallReceivedCall Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class WebhookPayloadCallReceivedCall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookPayloadCallReceived_call';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Internal Zernio Call doc id
     *
     * @return self
     */
     ...
     * Sets meta_call_id
     *
     * @param string|null $meta_call_id Meta wacid.* call id when known
     *
     * @return self
     */
     ...
     *
     * @param string|null $phone_number_id Meta phone_number_id
     *
     * @return self
     */
     ...
     * Sets from
     *
     * @param string|null $from Consumer wa_id / E.164
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param string|null $to Business number (E.164)
     *
     * @return self
     */
     ...
     * Sets forward_to
     *
     * @param string|null $forward_to Destination snapshot at routing time
     *
     * @return self
     */

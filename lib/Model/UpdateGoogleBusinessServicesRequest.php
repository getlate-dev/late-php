 ...
 */
class UpdateGoogleBusinessServicesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateGoogleBusinessServices_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['service_items'] === null) {
            $invalidProperties[] = "'service_items' can't be null";
        }

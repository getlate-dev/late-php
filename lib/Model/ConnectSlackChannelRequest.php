...
/**
 * ConnectSlackChannelRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ConnectSlackChannelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connectSlackChannel_request';
    ...
    */
     ...
     * Sets channel_id
     *
     * @param string $channel_id Slack channel id, C... or G...
     *
     * @return self
     */
     ...
     *
     * @param string|null $pending_data_token Nonce from the OAuth redirect. Required unless accountId is sent.
     *
     * @return self
     */
     ...
     * Sets account_id
     *
     * @param string|null $account_id Existing Slack account whose workspace token is reused. Required unless pendingDataToken is sent.
     *
     * @return self
     */

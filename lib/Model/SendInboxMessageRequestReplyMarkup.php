 ...
 */
class SendInboxMessageRequestReplyMarkup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sendInboxMessage_request_replyMarkup';
    ...
    public const TYPE_REPLY_KEYBOARD = 'reply_keyboard';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('one_time', $data ?? [], true);
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Keyboard type
     *
     * @return self
     */
     ...
     * Sets one_time
     *
     * @param bool|null $one_time Hide keyboard after use (reply_keyboard only)
     *
     * @return self
     */

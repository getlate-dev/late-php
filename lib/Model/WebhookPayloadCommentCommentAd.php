 ...
 */
class WebhookPayloadCommentCommentAd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookPayloadComment_comment_ad';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Meta ad ID (Instagram only).
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Ad creative title (Instagram only).
     *
     * @return self
     */

...
class InboxWebhookMessageSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'instagram_profile' => '\Zernio\Model\InboxWebhookMessageSenderInstagramProfile'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Sender's platform identifier. For WhatsApp this is the phone number (without leading `+`) when available, otherwise the `businessScopedUserId`. For other platforms, the platform's own user ID.
     *
     * @return self
     */
     ...
     *
     * @return \Zernio\Model\InboxWebhookMessageSenderInstagramProfile|null
     */
     ...
     *
     * @param \Zernio\Model\InboxWebhookMessageSenderInstagramProfile|null $instagram_profile instagram_profile
     *
     * @return self
     */

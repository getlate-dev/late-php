...
/**
 * ReplyToMentionRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ReplyToMentionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'replyToMention_request';
    ...
    */
     ...
     * Sets media_id
     *
     * @param string $media_id The ID of the media the account was mentioned in
     *
     * @return self
     */
     ...
     * Sets comment_id
     *
     * @param string|null $comment_id The mentioning comment's ID. Omit for a caption mention.
     *
     * @return self
     */

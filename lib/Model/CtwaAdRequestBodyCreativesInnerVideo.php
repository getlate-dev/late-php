 ...
 */
class CtwaAdRequestBodyCreativesInnerVideo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CtwaAdRequestBody_creatives_inner_video';
    ...
    */
     ...
     * Sets thumbnail_url
     *
     * @param string|null $thumbnail_url OPTIONAL: when omitted, the poster is auto-generated from Meta's own preferred video thumbnail. When Meta produces no candidate the request fails with a 502 platform_error (reason: video_thumbnail_unavailable).
     *
     * @return self
     */

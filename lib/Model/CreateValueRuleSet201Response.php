...
/**
 * CreateValueRuleSet201Response Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateValueRuleSet201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createValueRuleSet_201_response';
    ...
    */
     ...
     *
     * @param string|null $value_rule_set_id The new rule set id. Meta does not document the create response body, so this is null on the (unobserved) case where it omits the id.
     *
     * @return self
     */
    public function setValueRuleSetId($value_rule_set_id)
    {
        if (is_null($value_rule_set_id)) {
            array_push($this->openAPINullablesSetToNull, 'value_rule_set_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('value_rule_set_id', $nullablesSetToNull);
            if ($index !== FALSE) {

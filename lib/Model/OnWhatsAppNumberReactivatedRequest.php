...
/**
 * OnWhatsAppNumberReactivatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class OnWhatsAppNumberReactivatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'onWhatsAppNumberReactivated_request';
    ...
    public const EVENT_WHATSAPP_NUMBER_REACTIVATED = 'whatsapp.number.reactivated';
    ...
    {
        return [
            self::EVENT_WHATSAPP_NUMBER_REACTIVATED,
        ];
    }

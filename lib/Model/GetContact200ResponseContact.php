...
/**
 * GetContact200ResponseContact Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class GetContact200ResponseContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getContact_200_response_contact';
    ...
    */
     ...
     *
     * @param string[]|null $conversation_ids conversation_ids
     *
     * @return self
     */
    public function setConversationIds($conversation_ids)
    {
        if (is_null($conversation_ids)) {
            throw new \InvalidArgumentException('non-nullable conversation_ids cannot be null');
        }

...
/**
 * ConnectShopifyWithTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ConnectShopifyWithTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connectShopifyWithToken_request';
    ...
    */
     ...
     * Sets shop
     *
     * @param string $shop The myshopify.com store domain, e.g. `your-store.myshopify.com` (the bare `your-store` prefix is accepted too).
     *
     * @return self
     */
     ...
     * Sets access_token
     *
     * @param string $access_token Admin API access token of the merchant-created custom app (starts with `shpat_`).
     *
     * @return self
     */

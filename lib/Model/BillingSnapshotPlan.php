...
/**
 * BillingSnapshotPlan Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class BillingSnapshotPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingSnapshot_plan';
    ...
    */
     ...
     * Sets is_usage_based
     *
     * @param bool|null $is_usage_based is_usage_based
     *
     * @return self
     */
    public function setIsUsageBased($is_usage_based)
    {
        if (is_null($is_usage_based)) {

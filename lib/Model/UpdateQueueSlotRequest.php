...
/**
 * UpdateQueueSlotRequest Class Doc Comment
 *
 * @category Class
 * @package  Late
 * @author   OpenAPI Generator team
 ...
 */
class UpdateQueueSlotRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateQueueSlot_request';
    ...
    protected static $setters = [
        ...
        'reshuffle_existing' => 'setReshuffleExisting'
    ];
    ...
    protected static $getters = [
        ...
        'reshuffle_existing' => 'getReshuffleExisting'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('reshuffle_existing', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets queue_id
     *
     * @param string|null $queue_id Queue ID to update (optional)
     *
     * @return self
     */
     ...
     * Sets set_as_default
     *
     * @param bool|null $set_as_default Make this queue the default
     *
     * @return self
     */
    ...
    /**
     * Gets reshuffle_existing
     *
     * @return bool|null
     */
    public function getReshuffleExisting()
    {
        return $this->container['reshuffle_existing'];
    }

    /**
     * Sets reshuffle_existing
     *
     * @param bool|null $reshuffle_existing Whether to reschedule existing queued posts to match new slots
     *
     * @return self
     */
    public function setReshuffleExisting($reshuffle_existing)
    {
        if (is_null($reshuffle_existing)) {
            throw new \InvalidArgumentException('non-nullable reshuffle_existing cannot be null');
        }
        $this->container['reshuffle_existing'] = $reshuffle_existing;

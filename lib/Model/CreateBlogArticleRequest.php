...
/**
 * CreateBlogArticleRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateBlogArticleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createBlogArticle_request';
    ...
    protected static $openAPITypes = [
        ...
        'author' => 'string',
        'excerpt' => 'string',
        'image' => '\Zernio\Model\CreateBlogArticleRequestImage',
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateBlogArticleRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets author
     *
     * @param string|null $author Display name of the article author.
     *
     * @return self
     */
     ...
     * Gets image
     *
     * @return \Zernio\Model\CreateBlogArticleRequestImage|null
     */
     ...
     * Sets image
     *
     * @param \Zernio\Model\CreateBlogArticleRequestImage|null $image image
     *
     * @return self
     */
     ...
     * Sets is_published
     *
     * @param bool|null $is_published Set false to create the article as a draft.
     *
     * @return self
     */

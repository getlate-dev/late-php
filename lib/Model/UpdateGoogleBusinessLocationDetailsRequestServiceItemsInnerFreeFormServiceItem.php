 ...
 */
class UpdateGoogleBusinessLocationDetailsRequestServiceItemsInnerFreeFormServiceItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateGoogleBusinessLocationDetails_request_serviceItems_inner_freeFormServiceItem';
    ...
    */
     ...
     * Sets category
     *
     * @param string|null $category Category resource name this service belongs to (e.g. 'categories/gcid:laundromat')
     *
     * @return self
     */

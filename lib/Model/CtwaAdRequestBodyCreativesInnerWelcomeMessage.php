...
/**
 * CtwaAdRequestBodyCreativesInnerWelcomeMessage Class Doc Comment
 *
 * @category Class
 ...
 */
class CtwaAdRequestBodyCreativesInnerWelcomeMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CtwaAdRequestBody_creatives_inner_welcomeMessage';
    ...
    */
     ...
     * Sets text
     *
     * @param string $text Greeting shown when the chat opens. Replaces Meta's default.
     *
     * @return self
     */
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling CtwaAdRequestBodyCreativesInnerWelcomeMessage., must be bigger than or equal to 1.');
        }
     ...
     * Sets prefill_text
     *
     * @param string $prefill_text Message put into the user's text input, ready to send. Replaces Meta's default.
     *
     * @return self
     */
    public function setPrefillText($prefill_text)
    {
        ...
        if ((mb_strlen($prefill_text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prefill_text when calling CtwaAdRequestBodyCreativesInnerWelcomeMessage., must be bigger than or equal to 1.');
        }

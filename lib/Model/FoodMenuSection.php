 ...
 */
class FoodMenuSection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FoodMenuSection';
    ...
    */
    ...
    public function setLabels($labels)
    {
        ...
        if ((count($labels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $labels when calling FoodMenuSection., number of items must be greater than or equal to 1.');
        }

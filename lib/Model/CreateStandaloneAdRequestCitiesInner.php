...
/**
 * CreateStandaloneAdRequestCitiesInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateStandaloneAdRequestCitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createStandaloneAd_request_cities_inner';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key Meta city ID, from /v1/ads/targeting/search results.
     *
     * @return self
     */
     ...
     * Sets radius
     *
     * @param float|null $radius Optional radius around the city. Must be set together with distance_unit. Meta enforces a minimum city radius (~17 km / 10 mi); smaller values resolve to a 0-size audience and the ad fails at launch. For a tighter catchment use customLocations (lat/lng).
     *
     * @return self
     */
     ...
     * Sets distance_unit
     *
     * @param string|null $distance_unit Unit for radius. Required if radius is set.
     *
     * @return self
     */

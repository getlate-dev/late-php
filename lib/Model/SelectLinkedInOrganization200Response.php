 ...
 */
class SelectLinkedInOrganization200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'selectLinkedInOrganization_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bulk_refresh', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url The redirect URL with connection params appended (only if redirect_url was provided in request)
     *
     * @return self
     */
    ...
    {
        return $this->container['bulk_refresh'];
    }
     ...
     * @return self
     */
    public function setBulkRefresh($bulk_refresh)
    {
        if (is_null($bulk_refresh)) {
            throw new \InvalidArgumentException('non-nullable bulk_refresh cannot be null');
        }
        $this->container['bulk_refresh'] = $bulk_refresh;

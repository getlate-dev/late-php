 ...
 */
class GetGoogleBusinessSearchKeywords200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getGoogleBusinessSearchKeywords_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('month_range', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['month_range'];
    }
     ...
     * @return self
     */
    public function setMonthRange($month_range)
    {
        if (is_null($month_range)) {
            throw new \InvalidArgumentException('non-nullable month_range cannot be null');
        }
        $this->container['month_range'] = $month_range;

...
/**
 * SendInboxMessageRequestContactsInnerName Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class SendInboxMessageRequestContactsInnerName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sendInboxMessage_request_contacts_inner_name';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['formatted_name'] === null) {
            $invalidProperties[] = "'formatted_name' can't be null";
        }
     ...
     * Sets formatted_name
     *
     * @param string $formatted_name Full display name.
     *
     * @return self
     */

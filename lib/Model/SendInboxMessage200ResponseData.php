...
class SendInboxMessage200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets message_id
     *
     * @param string|null $message_id ID of the sent message (not returned for Reddit)
     *
     * @return self
     */
     ...
     *
     * @param string|null $conversation_id Twitter conversation ID
     *
     * @return self
     */
     ...
     * Sets sent_at
     *
     * @param \DateTime|null $sent_at Bluesky sent timestamp
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Success message (Reddit only)
     *
     * @return self
     */

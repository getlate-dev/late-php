...
/**
 * CtwaAdRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CtwaAdRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CtwaAdRequestBody';
    ...
    */
    ...
    public function setAccountId($account_id)
    {
        ...
        if ((mb_strlen($account_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling CtwaAdRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((mb_strlen($ad_account_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ad_account_id when calling CtwaAdRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CtwaAdRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setHeadline($headline)
    {
        ...
        if ((mb_strlen($headline) > 255)) {
            throw new \InvalidArgumentException('invalid length for $headline when calling CtwaAdRequestBody., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($headline) < 1)) {
            throw new \InvalidArgumentException('invalid length for $headline when calling CtwaAdRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setBody($body)
    {
        ...
        if ((mb_strlen($body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $body when calling CtwaAdRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCreatives($creatives)
    {
        ...
        if ((count($creatives) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creatives when calling CtwaAdRequestBody., number of items must be greater than or equal to 1.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CtwaAdRequestBody., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CtwaAdRequestBody., must be bigger than or equal to 3.');
        }
    ...
    public function setAgeMin($age_min)
    {
        ...
        if (($age_min > 65)) {
            throw new \InvalidArgumentException('invalid value for $age_min when calling CtwaAdRequestBody., must be smaller than or equal to 65.');
        }
        if (($age_min < 13)) {
            throw new \InvalidArgumentException('invalid value for $age_min when calling CtwaAdRequestBody., must be bigger than or equal to 13.');
        }
    ...
    public function setAgeMax($age_max)
    {
        ...
        if (($age_max > 65)) {
            throw new \InvalidArgumentException('invalid value for $age_max when calling CtwaAdRequestBody., must be smaller than or equal to 65.');
        }
        if (($age_max < 13)) {
            throw new \InvalidArgumentException('invalid value for $age_max when calling CtwaAdRequestBody., must be bigger than or equal to 13.');
        }
    ...
    public function setDsaBeneficiary($dsa_beneficiary)
    {
        ...
        if ((mb_strlen($dsa_beneficiary) > 100)) {
            throw new \InvalidArgumentException('invalid length for $dsa_beneficiary when calling CtwaAdRequestBody., must be smaller than or equal to 100.');
        }
    ...
    public function setDsaPayor($dsa_payor)
    {
        ...
        if ((mb_strlen($dsa_payor) > 100)) {
            throw new \InvalidArgumentException('invalid length for $dsa_payor when calling CtwaAdRequestBody., must be smaller than or equal to 100.');
        }

...
/**
 * UpdateWhatsAppFlowRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UpdateWhatsAppFlowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateWhatsAppFlow_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['categories']) && (count($this->container['categories']) < 1)) {
     ...
     * Sets name
     *
     * @param string|null $name New flow name
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateWhatsAppFlowRequest., must be smaller than or equal to 128.');
        }

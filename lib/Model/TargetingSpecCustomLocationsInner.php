...
/**
 * TargetingSpecCustomLocationsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class TargetingSpecCustomLocationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TargetingSpec_customLocations_inner';
    ...
    */
    ...
    public function setLatitude($latitude)
    {
        ...
        if (($latitude > 90)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling TargetingSpecCustomLocationsInner., must be smaller than or equal to 90.');
        }
        if (($latitude < -90)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling TargetingSpecCustomLocationsInner., must be bigger than or equal to -90.');
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if (($longitude > 180)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling TargetingSpecCustomLocationsInner., must be smaller than or equal to 180.');
        }
        if (($longitude < -180)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling TargetingSpecCustomLocationsInner., must be bigger than or equal to -180.');
        }
     ...
     * Sets radius
     *
     * @param float $radius Positive radius around the point.
     *
     * @return self
     */

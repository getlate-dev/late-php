 ...
 */
class ListGoogleBusinessPlaceActions200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listGoogleBusinessPlaceActions_200_response';
    ...
    protected static $setters = [
        ...
        'place_action_links' => 'setPlaceActionLinks',
    ...
    protected static $getters = [
        ...
        'place_action_links' => 'getPlaceActionLinks',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('place_action_links', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['place_action_links'];
    }
     ...
     * @return self
     */
    public function setPlaceActionLinks($place_action_links)
    {
        if (is_null($place_action_links)) {
            throw new \InvalidArgumentException('non-nullable place_action_links cannot be null');
        }
        $this->container['place_action_links'] = $place_action_links;

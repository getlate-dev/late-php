...
/**
 * SelectInstagramAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class SelectInstagramAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'selectInstagramAccount_request';
    ...
    */
     ...
     * Sets page_id
     *
     * @param string $page_id The Facebook Page ID selected by the user, from GET /v1/connect/instagram/select-account
     *
     * @return self
     */
     ...
     * Sets temp_token
     *
     * @param string $temp_token Long-lived Facebook user access token from the OAuth callback redirect
     *
     * @return self
     */

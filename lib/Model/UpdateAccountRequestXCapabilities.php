 ...
 */
class UpdateAccountRequestXCapabilities implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateAccount_request_xCapabilities';
    ...
    */
     ...
     * Sets inbox
     *
     * @param bool|null $inbox Enable DM polling and inbox sync for this X account. DM reads are metered as `dm_event_read` (~$0.010/call) and DM sends as `dm_interaction_create` (~$0.015/call), both billed pass-through. DM sends fire only on user-initiated actions; reads/polling fire only when this flag is true.
     *
     * @return self
     */

...
/**
 * GetGoogleBusinessAttributes200ResponseAttributesInner Class Doc Comment
 *
 * @category Class
 * @package  Late
 * @author   OpenAPI Generator team
 ...
 */
class GetGoogleBusinessAttributes200ResponseAttributesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getGoogleBusinessAttributes_200_response_attributes_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Attribute identifier (e.g. has_delivery)
     *
     * @return self
     */
     ...
     * Sets value_type
     *
     * @param string|null $value_type Value type (BOOL, ENUM, URL, REPEATED_ENUM)
     *
     * @return self
     */

    ...
    */
    ...
    public function setEngagementSources($engagement_sources)
    {
        ...
        if ((count($engagement_sources) > 50)) {
            throw new \InvalidArgumentException('invalid value for $engagement_sources when calling UploadedOrDerivedAudience., number of items must be less than or equal to 50.');
        }
        if ((count($engagement_sources) < 1)) {
            throw new \InvalidArgumentException('invalid length for $engagement_sources when calling UploadedOrDerivedAudience., number of items must be greater than or equal to 1.');
        }
    ...
    public function setCompanies($companies)
    {
        ...
        if ((count($companies) > 300000)) {
            throw new \InvalidArgumentException('invalid value for $companies when calling UploadedOrDerivedAudience., number of items must be less than or equal to 300000.');
        }
        if ((count($companies) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companies when calling UploadedOrDerivedAudience., number of items must be greater than or equal to 1.');
        }

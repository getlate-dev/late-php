 ...
 */
class BulkUpdateAdCampaignStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bulkUpdateAdCampaignStatus_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['campaigns']) > 50)) {
            $invalidProperties[] = "invalid value for 'campaigns', number of items must be less than or equal to 50.";
        }
    ...
    public function setCampaigns($campaigns)
    {
        ...
        if ((count($campaigns) > 50)) {
            throw new \InvalidArgumentException('invalid value for $campaigns when calling BulkUpdateAdCampaignStatusRequest., number of items must be less than or equal to 50.');
        }

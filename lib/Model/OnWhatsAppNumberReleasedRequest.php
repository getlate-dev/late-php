...
/**
 * OnWhatsAppNumberReleasedRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class OnWhatsAppNumberReleasedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'onWhatsAppNumberReleased_request';
    ...
    public const EVENT_WHATSAPP_NUMBER_RELEASED = 'whatsapp.number.released';
    ...
    {
        return [
            self::EVENT_WHATSAPP_NUMBER_RELEASED,
        ];
    }

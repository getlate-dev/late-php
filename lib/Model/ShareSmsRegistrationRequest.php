...
/**
 * ShareSmsRegistrationRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ShareSmsRegistrationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shareSmsRegistration_request';
    ...
    */
     ...
     * Sets number_id
     *
     * @param string $number_id Your phone number's ID (from GET /v1/phone-numbers).
     *
     * @return self
     */

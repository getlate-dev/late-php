...
/**
 * CreateInboxConversationRequestHeaderMedia Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateInboxConversationRequestHeaderMedia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createInboxConversation_request_headerMedia';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Must match the template header's media type.
     *
     * @return self
     */
     ...
     * Sets filename
     *
     * @param string|null $filename Document display name shown to the recipient (e.g. \"Factura 0001-123.pdf\"). document type only; ignored for image/video.
     *
     * @return self
     */

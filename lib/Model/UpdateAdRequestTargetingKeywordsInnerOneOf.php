...
/**
 * UpdateAdRequestTargetingKeywordsInnerOneOf Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAdRequestTargetingKeywordsInnerOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateAd_request_targeting_keywords_inner_oneOf';
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 80)) {
            throw new \InvalidArgumentException('invalid length for $text when calling UpdateAdRequestTargetingKeywordsInnerOneOf., must be smaller than or equal to 80.');
        }

...
/**
 * GetWhatsAppCalling200Response Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class GetWhatsAppCalling200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getWhatsAppCalling_200_response';
    ...
    */
     ...
     * Sets call_deep_link
     *
     * @param string|null $call_deep_link Public calling deep link (https://wa.me/call/<number>). Null while calling is disabled.
     *
     * @return self
     */
    ...
    /**
     * Gets outbound_disabled
     *
     * @return bool|null
     */
    public function getOutboundDisabled()
    {
        return $this->container['outbound_disabled'];
    }

    /**
     * Sets outbound_disabled
     *
     * @param bool|null $outbound_disabled True when the number's country blocks business-initiated (outbound) WhatsApp calling; inbound still works.
     *
     * @return self
     */
    public function setOutboundDisabled($outbound_disabled)
    {
        if (is_null($outbound_disabled)) {
            throw new \InvalidArgumentException('non-nullable outbound_disabled cannot be null');
        }
        $this->container['outbound_disabled'] = $outbound_disabled;
     ...
     * Sets caller_id_mode
     *
     * @param string|null $caller_id_mode Caller ID the forward-leg callee sees on tel: forwards. business = this WhatsApp number; platform = a Zernio number (used when the number was brought by the customer and its caller ID is not verified for PSTN origination).
     *
     * @return self
     */
     ...
     *
     * @param bool|null $caller_id_verified True once the number completed caller-ID verification, making tel: forwards display the business number itself.
     *
     * @return self
     */

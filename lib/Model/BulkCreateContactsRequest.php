 ...
 */
class BulkCreateContactsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bulkCreateContacts_request';
    ...
    */
    ...
    public function setContacts($contacts)
    {
        ...
        if ((count($contacts) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $contacts when calling BulkCreateContactsRequest., number of items must be less than or equal to 1000.');
        }

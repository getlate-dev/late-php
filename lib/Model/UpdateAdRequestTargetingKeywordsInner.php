...
/**
 * UpdateAdRequestTargetingKeywordsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAdRequestTargetingKeywordsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateAd_request_targeting_keywords_inner';
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 80)) {
            throw new \InvalidArgumentException('invalid length for $text when calling UpdateAdRequestTargetingKeywordsInner., must be smaller than or equal to 80.');
        }

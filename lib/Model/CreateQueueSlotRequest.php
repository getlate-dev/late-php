 ...
 */
class CreateQueueSlotRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createQueueSlot_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Queue name (e.g., Evening Posts)
     *
     * @return self
     */

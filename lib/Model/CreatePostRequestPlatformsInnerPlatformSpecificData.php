 ...
 */
class CreatePostRequestPlatformsInnerPlatformSpecificData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createPost_request_platforms_inner_platformSpecificData';
    ...
    */
    ...
    public function setTopicTag($topic_tag)
    {
        ...
        if ((mb_strlen($topic_tag) > 50)) {
            throw new \InvalidArgumentException('invalid length for $topic_tag when calling CreatePostRequestPlatformsInnerPlatformSpecificData., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($topic_tag) < 1)) {
            throw new \InvalidArgumentException('invalid length for $topic_tag when calling CreatePostRequestPlatformsInnerPlatformSpecificData., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstComment($first_comment)
    {
        ...
        if ((mb_strlen($first_comment) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $first_comment when calling CreatePostRequestPlatformsInnerPlatformSpecificData., must be smaller than or equal to 10000.');
        }
    ...
    public function setThumbOffset($thumb_offset)
    {
        ...
        if (($thumb_offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $thumb_offset when calling CreatePostRequestPlatformsInnerPlatformSpecificData., must be bigger than or equal to 0.');
        }
    ...
    public function setVideoCoverTimestampMs($video_cover_timestamp_ms)
    {
        ...
        if (($video_cover_timestamp_ms < 0)) {
            throw new \InvalidArgumentException('invalid value for $video_cover_timestamp_ms when calling CreatePostRequestPlatformsInnerPlatformSpecificData., must be bigger than or equal to 0.');
        }
    ...
    public function setPhotoCoverIndex($photo_cover_index)
    {
        ...
        if (($photo_cover_index < 0)) {
            throw new \InvalidArgumentException('invalid value for $photo_cover_index when calling CreatePostRequestPlatformsInnerPlatformSpecificData., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreatePostRequestPlatformsInnerPlatformSpecificData., must be smaller than or equal to 4000.');
        }
    ...
    public function setEmbeds($embeds)
    {
        ...
        if ((count($embeds) > 10)) {
            throw new \InvalidArgumentException('invalid value for $embeds when calling CreatePostRequestPlatformsInnerPlatformSpecificData., number of items must be less than or equal to 10.');
        }
    ...
    public function setForumAppliedTags($forum_applied_tags)
    {
        ...
        if ((count($forum_applied_tags) > 5)) {
            throw new \InvalidArgumentException('invalid value for $forum_applied_tags when calling CreatePostRequestPlatformsInnerPlatformSpecificData., number of items must be less than or equal to 5.');
        }

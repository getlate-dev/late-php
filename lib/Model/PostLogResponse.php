...
/**
 * PostLogResponse Class Doc Comment
 *
 * @category Class
 * @package  Late
 * @author   OpenAPI Generator team
 ...
 */
class PostLogResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostLog_response';
    ...
    */
     ...
     *
     * @param string|null $platform_post_id ID returned by platform on success
     *
     * @return self
     */
     ...
     *
     * @param string|null $platform_post_url URL of published post
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Error message on failure
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param string|null $error_code Platform-specific error code
     *
     * @return self
     */
     ...
     * Sets raw_body
     *
     * @param string|null $raw_body Full response body JSON (max 5000 chars)
     *
     * @return self
     */

...
/**
 * SendWhatsAppConversion200Response Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class SendWhatsAppConversion200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sendWhatsAppConversion_200_response';
    ...
    */
     ...
     *
     * @param int|null $events_received Events accepted by Meta.
     *
     * @return self
     */
     ...
     * Sets events_failed
     *
     * @param int|null $events_failed Events rejected by Meta (see failures).
     *
     * @return self
     */
     ...
     * Sets failures
     *
     * @param \Zernio\Model\SendConversions200ResponseFailuresInner[]|null $failures Per-event failure detail. Empty when all events were accepted.
     *
     * @return self
     */
     ...
     * Sets trace_id
     *
     * @param string|null $trace_id Meta `fbtrace_id` for debugging. Surface in support tickets.
     *
     * @return self
     */

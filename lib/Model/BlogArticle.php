...
class BlogArticle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Platform-native article id (numeric string for Shopify).
     *
     * @return self
     */
     ...
     * Sets published_at
     *
     * @param \DateTime|null $published_at When the article was (or is scheduled to be) published; null for drafts.
     *
     * @return self
     */

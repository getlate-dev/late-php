...
/**
 * UnpublishPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UnpublishPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'unpublishPost_request';
    ...
    */
     ...
     * Sets platform
     *
     * @param string $platform The platform to delete the post from
     *
     * @return self
     */

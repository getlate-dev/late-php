...
/**
 * SelectInstagramAccount200ResponseAccount Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class SelectInstagramAccount200ResponseAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'selectInstagramAccount_200_response_account';
    ...
    public const LOGIN_METHOD_FACEBOOK_LOGIN = 'facebook_login';
     ...
     * @return string[]
     */
    public function getLoginMethodAllowableValues()
    {
        return [
            self::LOGIN_METHOD_FACEBOOK_LOGIN,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getLoginMethodAllowableValues();
        if (!is_null($this->container['login_method']) && !in_array($this->container['login_method'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'login_method', must be one of '%s'",
                $this->container['login_method'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets display_name
     *
     * @param string|null $display_name Name of the Facebook Page backing this account
     *
     * @return self
     */
    ...
    public function setLoginMethod($login_method)
    {
        if (is_null($login_method)) {
            throw new \InvalidArgumentException('non-nullable login_method cannot be null');
        }
        $allowedValues = $this->getLoginMethodAllowableValues();
        if (!in_array($login_method, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'login_method', must be one of '%s'",
                    $login_method,
